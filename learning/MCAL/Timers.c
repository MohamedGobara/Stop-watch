...
static void (*Timer0_OCA_Fptr) (void)=NULL_PTR;
...
/*************************Pointer to functions to be assigned to ISR Timer2 *********************************/

static void (*Timer2_OVF_Fptr) (void)=NULL_PTR;
static void (*Timer2_OCA_Fptr) (void)=NULL_PTR;
/******************************************************************************************/
/*timer 0 functions*/
...
void Timer1_Init( Timer1Mode_type mode,Timer1Scaler_type scaler)
{
	switch (mode)
	{
		...
		break;
		case TIMER1_PhaseCorrect8bit_MODE:
		SET_BIT(TCCR1A,WGM10);
		CLR_BIT(TCCR1A,WGM11);
		CLR_BIT(TCCR1B,WGM12);
		CLR_BIT(TCCR1B,WGM13);
		break;
		case TIMER1_PhaseCorrect9bit_MODE:
		CLR_BIT(TCCR1A,WGM10);
		SET_BIT(TCCR1A,WGM11);
		CLR_BIT(TCCR1B,WGM12);
		CLR_BIT(TCCR1B,WGM13);
		break;
		case TIMER1_PhaseCorrect10bit_MODE:
		SET_BIT(TCCR1A,WGM10);
		SET_BIT(TCCR1A,WGM11);
		CLR_BIT(TCCR1B,WGM12);
		CLR_BIT(TCCR1B,WGM13);
		...
		case TIMER1_PhaseCorrect_OCR1A_MODE:
		SET_BIT(TCCR1A,WGM10);
		SET_BIT(TCCR1A,WGM11);
		CLR_BIT(TCCR1B,WGM12);
		SET_BIT(TCCR1B,WGM13);
...
{
	if(edge==TIMERICU_RISING)
	SET_BIT(TCCR1B,ICES1);
	
	else if(edge==TIMERICU_FALLING)
